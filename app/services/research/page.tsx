...
import {
  ...
  Globe, GraduationCap, MonitorPlay,
} from "lucide-react";
...
export const metadata: Metadata = {
  title: "Research & Academic Services | WAARC",
  description:
    "Expert research support including paper writing, international journal publication, methodology training, thesis guidance, and academic seminars.",
  alternates: { canonical: "https://waarc.edu.np/services/research" },
  openGraph: {
    title: "Research & Academic Services | WAARC",
    url: "https://waarc.edu.np/services/research",
  },
};
...
const breadcrumbsData = [
  ...
  { name: "Research", link: "/services/research" },
];
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#17254e] relative">
        <Image
          ...
          alt="Research services background"
          fill
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-slate-300 text-lg leading-relaxed">
              Empowering researchers, scholars, and institutions with expert support across every stage of the academic research journey.
            </p>
            <div className="mt-8">
              <Link
                href="/contact"
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="mb-12">
          <p className="text-xs font-semibold tracking-widest uppercase mb-3 text-yellow-500">What We Offer</p>
          <h2 className="text-3xl font-bold text-slate-900">Our Research Services</h2>
          <p className="mt-3 text-slate-500 max-w-3xl">
            From initial concept to international publication, end-to-end support tailored to your academic goals.
          </p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.tags.map((tag, j) => (
                      <span key={j} className="text-xs font-medium rounded-full px-3 py-1 bg-blue-950/5 text-[#17254e]">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        <div className="rounded-3xl p-12 md:p-16 bg-[#17254e]">
          <div className="max-w-xl">
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-8">
              Connect with our academic experts today and take the next step toward publication, recognition, and impact.
            </p>
            <Link
              href="/contact"
